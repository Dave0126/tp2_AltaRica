...
<altarica>
  <define-block name="System">
    ...
    <define-parameter name="GS1.Receiver1.pMeu" type="Real">
      <Real value="0.025"/>
    </define-parameter>
    <define-parameter name="GS1.Receiver2.pLambda" type="Real">
      <Real value="1e-05"/>
    </define-parameter>
    <define-parameter name="GS1.Receiver2.pMeu" type="Real">
      <Real value="0.025"/>
    </define-parameter>
    <define-parameter name="GS1.Transmitter1.pLambda" type="Real">
      <Real value="1e-05"/>
    </define-parameter>
    <define-parameter name="GS1.Transmitter1.pMeu" type="Real">
      <Real value="0.025"/>
    </define-parameter>
    <define-parameter name="GS1.Transmitter2.pLambda" type="Real">
      <Real value="1e-05"/>
    </define-parameter>
    <define-parameter name="GS1.Transmitter2.pMeu" type="Real">
      <Real value="0.025"/>
    </define-parameter>
    ...
    <define-parameter name="GS2.Receiver1.pMeu" type="Real">
      <Real value="0.025"/>
    </define-parameter>
    <define-parameter name="GS2.Receiver2.pLambda" type="Real">
      <Real value="1e-05"/>
    </define-parameter>
    <define-parameter name="GS2.Receiver2.pMeu" type="Real">
      <Real value="0.025"/>
    </define-parameter>
    <define-parameter name="GS2.Transmitter1.pLambda" type="Real">
      <Real value="1e-05"/>
    </define-parameter>
    <define-parameter name="GS2.Transmitter1.pMeu" type="Real">
      <Real value="0.025"/>
    </define-parameter>
    <define-parameter name="GS2.Transmitter2.pLambda" type="Real">
      <Real value="1e-05"/>
    </define-parameter>
    <define-parameter name="GS2.Transmitter2.pMeu" type="Real">
      <Real value="0.025"/>
    </define-parameter>
    ...
    <define-event name="GS1.Receiver1.evRepair">
      <attribute name="delay">
        <exponential>
          <parameter name="GS1.Receiver1.pMeu"/>
        </exponential>
      </attribute>
    </define-event>
    ...
    <define-event name="GS1.Receiver2.evRepair">
      <attribute name="delay">
        <exponential>
          <parameter name="GS1.Receiver2.pMeu"/>
        </exponential>
      </attribute>
    </define-event>
    ...
    <define-event name="GS1.Transmitter1.evRepair">
      <attribute name="delay">
        <exponential>
          <parameter name="GS1.Transmitter1.pMeu"/>
        </exponential>
      </attribute>
    </define-event>
    ...
    <define-event name="GS1.Transmitter2.evRepair">
      <attribute name="delay">
        <exponential>
          <parameter name="GS1.Transmitter2.pMeu"/>
        </exponential>
      </attribute>
    </define-event>
    ...
    <define-event name="GS2.Receiver1.evRepair">
      <attribute name="delay">
        <exponential>
          <parameter name="GS2.Receiver1.pMeu"/>
        </exponential>
      </attribute>
    </define-event>
    ...
    <define-event name="GS2.Receiver2.evRepair">
      <attribute name="delay">
        <exponential>
          <parameter name="GS2.Receiver2.pMeu"/>
        </exponential>
      </attribute>
    </define-event>
    ...
    <define-event name="GS2.Transmitter1.evRepair">
      <attribute name="delay">
        <exponential>
          <parameter name="GS2.Transmitter1.pMeu"/>
        </exponential>
      </attribute>
    </define-event>
    ...
    <define-event name="GS2.Transmitter2.evRepair">
      <attribute name="delay">
        <exponential>
          <parameter name="GS2.Transmitter2.pMeu"/>
        </exponential>
      </attribute>
    </define-event>
    ...
    <define-event name="Sat.batteries_fail">
      <attribute name="delay">
        <constant>
          <Real value="1.0"/>
        </constant>
    ...
    <define-event name="SatRelay1.batteries_fail">
      <attribute name="delay">
        <constant>
          <Real value="1.0"/>
        </constant>
    ...
    <define-event name="SatRelay2.batteries_fail">
      <attribute name="delay">
        <constant>
          <Real value="1.0"/>
        </constant>
    ...
    <transition>
      <event name="GS1.Receiver1.evRepair"/>
      <not>
        <variable name="GS1.Receiver1.vsWorking"/>
      </not>
      <assignment>
    ...
    <transition>
      <event name="GS1.Receiver2.evRepair"/>
      <not>
        <variable name="GS1.Receiver2.vsWorking"/>
      </not>
      <assignment>
    ...
    <transition>
      <event name="GS1.Transmitter1.evRepair"/>
      <not>
        <variable name="GS1.Transmitter1.vsWorking"/>
      </not>
      <assignment>
    ...
    <transition>
      <event name="GS1.Transmitter2.evRepair"/>
      <not>
        <variable name="GS1.Transmitter2.vsWorking"/>
      </not>
      <assignment>
    ...
    <transition>
      <event name="GS2.Receiver1.evRepair"/>
      <not>
        <variable name="GS2.Receiver1.vsWorking"/>
      </not>
      <assignment>
    ...
    <transition>
      <event name="GS2.Receiver2.evRepair"/>
      <not>
        <variable name="GS2.Receiver2.vsWorking"/>
      </not>
      <assignment>
    ...
    <transition>
      <event name="GS2.Transmitter1.evRepair"/>
      <not>
        <variable name="GS2.Transmitter1.vsWorking"/>
      </not>
      <assignment>
    ...
    <transition>
      <event name="GS2.Transmitter2.evRepair"/>
      <not>
        <variable name="GS2.Transmitter2.vsWorking"/>
      </not>
      <assignment>
    ...
    <transition>
      <event name="SatRelay1.batteries_fail"/>
      <or>
        <variable name="SatRelay1.Battery1.vsWorking"/>
        <variable name="SatRelay1.Battery2.vsWorking"/>
      </or>
    ...
    <transition>
      <event name="SatRelay2.batteries_fail"/>
      <or>
        <variable name="SatRelay2.Battery1.vsWorking"/>
        <variable name="SatRelay2.Battery2.vsWorking"/>
      </or>
